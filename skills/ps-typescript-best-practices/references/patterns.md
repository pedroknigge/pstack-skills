...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic. See the **type-system-discipline** and **ps-principle-boundary-discipline** skills.
...
Validate once where data crosses in. Trust types inside. See the **ps-principle-boundary-discipline** skill.
