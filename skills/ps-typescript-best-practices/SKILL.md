...
Apply the **ps-principle-type-system-discipline** skill first.
...
| Boundary validation | Parse where data crosses in, into a named domain type. `Record<string, unknown>` (however spelled) stops at that parse. Trust types inside. See the **ps-principle-boundary-discipline** skill. |
