...
3. Migrate one component at a time. Parallelize across worktrees, one owner per component (the **ps-principle-separate-before-serializing-shared-state** skill). Shared primitives migrate first as a blocking phase.
