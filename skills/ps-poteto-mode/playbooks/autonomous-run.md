...
3. Each iteration makes the smallest change the evidence justifies, verifies it against the predicate, commits if it advanced, discards changes that didn't help. Belt-and-suspenders that "might help" gets reverted, not left to ride.
   Sequence the work via the **ps-principle-sequence-verifiable-units** skill, verifying each unit before the next instead of batching checks at the end.
...
5. Checkpoint every iteration via the **ps-show-me-your-work** skill, a row for what changed and whether the predicate moved.
